...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="loadPage('detail/pelanggan.php')">Member Ramah</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="loadPage('detail/transaksi.php')">Transaksi</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="loadPage('detail/produk.php')">Produk</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="loadPage('data/admin.php')">Data Admin</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="loadPage('detail/log.php')">Log Kasir</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container mt-5">
        <iframe id="contentFrame" src="detail/produk.php" style="width: 100%; height: 650px; border: none;"></iframe>
    </div>
