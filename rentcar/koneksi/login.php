...
if (isset($_POST['login'])) {
    ...
    $qadm = mysqli_query($db->kon, "SELECT * FROM admin WHERE usnm='$user' AND pass='$password'");
    ...
    if (mysqli_num_rows($qadm) > 0) {
        ...
        header("Location: ../dsadm.php");
        exit;
    }
    
    // Cek login pelanggan
    $qpel = mysqli_query($db->kon, "SELECT * FROM pelanggan WHERE usnm='$user' AND pass='$password'");
